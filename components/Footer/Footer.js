    ...
    <footer role="contentinfo" ref={ref} className={footerClasses} {...props}>
      <div className="footer--content s-box-page-default-h s-box-default-v s-center">
        <div className="footer--header s-stack-large">
          ...
          <div className="footer--title c-content-dark-secondary">
            <h2 className="t-title-small">University Libraries</h2>
            <address className="t-body-medium">
              <p>
                McKeldin Library, 7649 Library Lane, College Park, MD 20742-7011
              </p>
              <a href="tel:+13014050800">301.405.0800</a>
            </address>
          </div>
        </div>
        <div className="footer--columns t-body-small">
          <div className="footer--columns-main">
            ...
            >
              ...
              <ul className="social-media-list s-box-default-h">
